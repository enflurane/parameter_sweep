...
- **本工作**: [Complex bifurcations and new types of structure uncovered in the Qi system](https://www.sciencedirect.com/science/article/pii/S0378475425005440) - 本项目相关的学术论文
- **重要参考文献**: [Homoclinic chaos in the Rossler model](https://pubs.aip.org/aip/chaos/article-abstract/30/11/113126/595937/Homoclinic-chaos-in-the-Rossler-model?redirectedFrom=fulltext)
